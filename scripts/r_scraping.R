...
setwd("C:/Users/modes/Desktop/Rinkimai")

p_needed <-
  c("dplyr","ggplot2","rgdal","RSelenium",
...
vienmandat <- full_join(vienmandat_apygard,vienmandat_apyl, by = c("Kandidatas", "Iðkëlë"),
